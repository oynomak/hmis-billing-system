CREATE PROCEDURE FACTURE_de_TOUS_les_ACTES_MEDICAUX_de_CONSULTATION_Patient
...
WHERE     (dbo.FACTURES.ID_CONSULTATION = @ID_CONSULTATION) AND (dbo.FACTURE_DETAILS.PAYE = 1)
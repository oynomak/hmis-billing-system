<%@ Page Language="C#" MasterPageFile="~/MASTER_PAGES/MasterPage_INFIRMIERS.master" AutoEventWireup="true"
                                ...
                                <tr>
                                    <td align="right" style="width: 242px">
                                        <asp:Button ID="ChangePasswordPushButton" runat="server" BackColor="CornflowerBlue"
                                            ...
                                            ValidationGroup="ChangePassword1" PostBackUrl="~/INFIRMIERES/Nurses_Page.aspx" />
                                    </td>
                                    <td>

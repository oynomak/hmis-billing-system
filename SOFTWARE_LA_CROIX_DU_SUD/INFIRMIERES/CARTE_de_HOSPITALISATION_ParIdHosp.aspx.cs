...
public partial class REGISTRATION_CARTE_DE_CONSULTATION : System.Web.UI.Page
{
    ...
    {
        TextBox_ID_CONSULTATION.Text = Request.Params["paraHOSPIT"].ToString();
        ...
        cmd.Parameters.Add("@IDHospitalisation", SqlDbType.NVarChar).Value = TextBox_ID_CONSULTATION.Text;
        //cnn.Open();
        //cmd.ExecuteNonQuery();
        //cmd.Dispose();
        //cnn.Close();

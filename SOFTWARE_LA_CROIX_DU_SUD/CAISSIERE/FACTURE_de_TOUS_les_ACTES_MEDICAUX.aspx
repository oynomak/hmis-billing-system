<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FACTURE_de_TOUS_les_ACTES_MEDICAUX.aspx.cs" Inherits="CAISSIERE_FACTURE_de_TOUS_les_ACTES_MEDICAUX" %>
...
<head runat="server">
    <title>Facture de tous les actes médicaux</title>
...
<body style="vertical-align: top; background-color: #f0f8ff; text-align: center">
    ...
    <table>
            ...
            <tr>
                ...
                <td style="width: 3px; background-color: #ffffff; text-align: left; border-right: dodgerblue thin solid; border-top: dodgerblue thin solid; border-left: dodgerblue thin solid; border-bottom: dodgerblue thin solid; height: 40px;">
                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                        HasCrystalLogo="False" HasDrillUpButton="False" HasExportButton="False" HasGotoPageButton="False"
                        HasPageNavigationButtons="False" HasSearchButton="False" HasToggleGroupTreeButton="False"
                        HasViewList="False" Height="50px" Width="350px" DisplayGroupTree="False" ReuseParameterValuesOnRefresh="True" />
                </td>
                <td style="height: 40px">
                </td>
            </tr>

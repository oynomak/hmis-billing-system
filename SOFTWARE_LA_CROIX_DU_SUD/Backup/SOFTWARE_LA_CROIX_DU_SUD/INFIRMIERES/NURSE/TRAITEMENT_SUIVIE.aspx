<%@ Page Language="C#" MasterPageFile="~/MASTER_PAGES/INFIRMIERS.master" AutoEventWireup="true" CodeFile="TRAITEMENT_SUIVIE.aspx.cs" Inherits="INFIRMIERES_NURSE_TRAITEMENT_SUIVIE" Title="TRAITEMENT DE SUIVIE" %>

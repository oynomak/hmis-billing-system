...
public partial class REGISTRATION_PATIENTS : System.Web.UI.Page
{
    ...
    {
        //TextBox_ID_PATIENT_parameter.Text = Request.Params["para"].ToString();
        ...
        //cmd.Parameters.Add("@NoPatient", SqlDbType.NVarChar).Value = TextBox_ID_PATIENT_parameter.Text;
        ...
        //string rptFile = Server.MapPath("~/CrystalReport_CARTE_de_PATIENT.rpt");
        //report.Load(rptFile);

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FACTURE_dela_CONSULTATION.aspx.cs"
    Inherits="CAISSIERE_FACTURE_dela_CONSULTATION" %>
...
<head runat="server">
    <title>Facture de rendez-vous</title>
                ...
                <tr>
                    ...
                    <td style="width: 3px; background-color: #ffffff; text-align: left; border-right: dodgerblue thin solid;
                        ...
                        <CR:CrystalReportViewer ID="CrystalReportViewer2" runat="server" AutoDataBind="True"
                            ...
                            HasGotoPageButton="False" HasPageNavigationButtons="False" HasToggleGroupTreeButton="False"
                            HasViewList="False" ReuseParameterValuesOnRefresh="True" HasRefreshButton="True" Height="50px" ReportSourceID="CrystalReportSource1" Width="350px" />
                    </td>
                    <td>
                    </td>
                </tr>

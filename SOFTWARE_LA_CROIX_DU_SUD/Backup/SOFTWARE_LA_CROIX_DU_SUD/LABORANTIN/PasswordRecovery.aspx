<%@ Page Language="C#" MasterPageFile="~/MASTER_PAGES/MasterPage_LABORATOIRE.master" AutoEventWireup="true"
                                ...
                                <tr>
                                    <td align="right" style="width: 242px">
                                        <asp:Button ID="ChangePasswordPushButton" runat="server" BackColor="CornflowerBlue"
                                            ...
                                            ValidationGroup="ChangePassword1" PostBackUrl="~/LABORANTIN/Laboratory_Page.aspx" />
                                    </td>
                                    <td>
